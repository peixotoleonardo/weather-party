...
export class SuggestTrackController {
  constructor(private readonly suggestTrackUseCase: ISuggestTrackUseCase) {}

  @Get()
  @UsePipes(new ValidationPipe({ transform: true }))
  execute(@Query() dto: SuggestTrackDTO) {
    return this.suggestTrackUseCase.execute(
      new SuggestTrackInputData(dto.cityName),
    );
  }
}
